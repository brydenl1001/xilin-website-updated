...
export default function StudentAttendance() {
  ...
  // This week: last 7 calendar days, mapped to whether a record exists/was present
  ...
  return (
    <div className="max-w-3xl animate-fade-in">
      <PageHeader title="My Attendance" subtitle="Your attendance record" />
